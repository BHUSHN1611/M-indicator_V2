...
function getOnlyFasttrain(){
  ...
  const onlyFastTrain = trainData.filter(trainData => trainData.train_type === "FAST")
...
const TrainList: React.FC = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#171717" }} edges={["top"]}>
      <TrainFilter borderColorAll="#1e3a5f" borderColorFast="white" borderColorSlow="#1e3a5f"/>
      <FlatList
